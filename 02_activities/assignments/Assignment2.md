...
```
Type 1 will overwrite the address data every time it's updated, Type 2 will create a new record with the updated address information, preserving the history of changes.
```
